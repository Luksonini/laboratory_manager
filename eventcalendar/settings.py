...
# STATIC_URL = "/static/"
# STATIC_ROOT = "laboratory_manager/static"
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # zmienione na 'staticfiles'

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # zostaje 'static'
]
